...
INSTITUTIONS = {
    ...
    "🇳🇴 노르웨이 국부펀드 (Norges Bank / GPFG)": {"cik": "0001438782", "desc": "세계 최대 규모의 글로벌 국부펀드, 미 증시 우상향의 과실을 통째로 흡수하는 가장 정석적인 인덱스형 거인."},
    "🇸🇦 사우디 국부펀드 (Public Investment Fund - PIF)": {"cik": "0001911299", "desc": "대규모 글로벌 전략적 투자, 성장성이 보이면 돈을 쏟아붓는 공격적인 벤처캐피털"},
