...
def render_consensus_view():
    ...
    st.caption("선택한 특정 분기(시점)에서 주요 글로벌 기관들이 동시에 보유하거나 집중 매수한 공통 종목을 발굴합니다.")
    ...
    m3.metric("동시 순매수/비중확대 종목", f"{co_buy_count:,} 개", help=f"선택한 {min_overlap}개 이상 기관이 동시에 신규 매수하거나 비중을 확대한 종목")
