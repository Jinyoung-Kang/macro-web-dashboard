...
from services.prompts import INVESTMENT_AGENT_PROMPT, SEC_13F_CONSENSUS_PROMPT
...
def call_selected_ai_engine(engine_name: str, prompt: str, system_prompt: str = None) -> dict:
    ...
    elif "GPT-OSS-20B" in engine_name:
